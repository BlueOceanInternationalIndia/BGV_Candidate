...
function mobileCodePopulate(Dropdown) {
    const ISO2_PhoneCodes = {
        ...
        "NZ": "64", "NP": "977", "NR": "674", "NU": "683", "CK": "682", "XK": "383", "CI": "225", "CH": "41", 
        ...
        "TH": "66", "TF": "262", "TG": "228", "TD": "235", "TC": "1-649", "LY": "218", "VA": "379", "VC": "1-784", 
        "AE": "971", "AD": "376", "AG": "1-268", "AF": "93", "AI": "1-264", "VI": "1-340", "IS": "354", 
        "IR": "98", "AM": "374", "AL": "355", "AO": "244", "AQ": "672", "AS": "1-684", "AR": "54", "AU": "61", 
    ...
    ISO2_CountryNames = {
        ...
        "IM": "Isle of Man", "IL": "Israel", "IT": "Italy", "CI": "Ivory Coast", "JM": "Jamaica", "JP": "Japan", 
        "JE": "Jersey", "JO": "Jordan", "KZ": "Kazakhstan", "KE": "Kenya", "KI": "Kiribati", "XK": "Kosovo", "KW": "Kuwait", 
        ...
        "PR": "Puerto Rico", "QA": "Qatar", "CG": "Republic of the Congo", "RE": "Reunion", "RO": "Romania", "RU": "Russia", 
        ...
        "CH": "Switzerland", "SY": "Syria", "TW": "Taiwan", "TJ": "Tajikistan", "TZ": "Tanzania", "TH": "Thailand", "TG": "Togo", 
    ...
    // Dropdown = document.getElementsByClassName('countryPhoneCodes');
    console.log("DROPDOWN", Dropdown);    

    for(let i = 0; i < Dropdown.length; i++) {
        Object.keys(ISO2_CountryNames).forEach((k) => {
            const val = ISO2_PhoneCodes[k],
                option = document.createElement('option'),
                img = document.createElement('img');
            // img.src = `./assets/flags/${k}.png`
            // console.log(img);
            option.value = val;
            option.innerHTML = `${ISO2_CountryNames[k]} (${val})`;
...
export default mobileCodePopulate
